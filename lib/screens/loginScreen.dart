            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text('مستخدم جديد', style: TextStyle(color: Colors.grey)),
                  Expanded(
                    child: Divider(
                      color: Colors.grey,
                      thickness: 1,
              ...
              ), // إضافة الفورم مباشرة هنا
              SizedBox(height: 15),
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => Sinup()));
                },
                child: Text('  إنضمام بستخدام  Google'),
              ...
              if (_formKey.currentState?.validate() ?? false) {
                try {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        'فشل في تسجيل الدخول: البريد الإلكتروني أو كلمة المرور غير صحيحة',
                      ),
                    ),
                  );
                }
